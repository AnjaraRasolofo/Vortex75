...
<div class="container py-5">
    ...
    <div class="row align-items-center mb-5">
        <div class="col-md-6">
            ...
            <div class="mt-4 d-flex gap-3">
                ...
                @else
                    <a href="#" class="btn btn-outline-secondary btn-lg">Mon compte</a>
                @endguest
            </div>
        </div>
        <div class="col-md-6">
    ...
    <div class="bg-light p-5 mt-5 rounded shadow-sm">
        ...
        <form action="{{ route('abonnement.newsletter') }}" method="POST" class="row g-3 mt-3">
            @csrf
            <div class="col-md-8">
